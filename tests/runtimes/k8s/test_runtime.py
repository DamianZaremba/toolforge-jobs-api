...
class TestUpdateContinuousJob:
    ...
    def test_only_replaces_all_if_everything_goes_ok(
        ...
        if with_publish:
            job = get_continuous_job_fixture_as_job(port=1234, publish="/")
            runtime_k8s_cli.get_objects.return_value = [
                {"metadata": {"name": "migrate", "resourceVersion": "12345"}}
            ]
        else:
            job = get_continuous_job_fixture_as_job()
    ...
    def test_with_publish_creates_httproute_when_it_does_not_exist(
        self,
        fake_tool_account: ToolAccount,
        fake_tool_account_uid: None,
        runtime_k8s_cli: MagicMock,
    ...
    def test_with_publish_replaces_httproute_when_it_exists(
        self,
        fake_tool_account: ToolAccount,
        fake_tool_account_uid: None,
        runtime_k8s_cli: MagicMock,
    ...
    def test_with_publish_httproute_creation_error_raises(
        self,
        fake_tool_account: ToolAccount,
        fake_tool_account_uid: None,
        runtime_k8s_cli: MagicMock,
